export const SendFormInviteTemplate = ({ email, url }:any) => {
  return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px; text-align: center;">
            <div style="background-color: #fff; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
                <img src="https://drive.google.com/file/d/1rzB-YgyCpEtFAsNXEtfcG0zK-d8jVSmN/view?usp=sharing" alt="MercForms Logo" style="max-width: 100px; margin: 0 auto; display: block;">
